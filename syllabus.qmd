...
* **Textbook (Required)**: _Practical Multivariate Analysis, 6th ed_ by Afifi, May, Donatello, Clark. [[Link]](https://www.routledge.com/Practical-Multivariate-Analysis/Afifi-May-Donatello-Clark/p/book/9781032088471)
* **Textbook (Optional)**: Open Intro Statistics 3rd edition. If you need a refresher on your basic statistics. Free PDF available at https://www.openintro.org/stat/textbook.php?stat_book=os
...
* I use a standard grade cutoff of 100-90\%: A, 89-80\%: B, 79-70\%: C. Plusses and minuses will be as displayed on Blackboard Learn. 
