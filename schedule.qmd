...
While the class is generally organized by calendar week, sometimes we will cover two topics in a week or one topic will span multiple weeks. Always start with the [Topics](topics.html) page to find the materials for that topic such as lecture notes and assignments. 
