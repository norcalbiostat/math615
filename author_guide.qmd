...
To facilitate authoring manuscripts in the required style, we require authors to use this [custom quarto template](journal/template.qmd) and [bibliography file](bibliography.bib). 
