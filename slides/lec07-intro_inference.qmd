...
::: {.callout-warning icon="false"}
This chapter makes reference to a number of case studies from chapter 11 and 12. You may need to follow the reference links in the online textbook on occasion to get more information and context. 
:::
