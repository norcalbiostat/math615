...
footer: "[🔗 https://norcalbiostat.github.io/MATH615](https://norcalbiostat.github.io/MATH615/) / Data Architecture"
from: markdown+emoji
format: 
  revealjs:
    theme: simple
...
![](https://datacarpentry.org/spreadsheets-socialsci/fig/single-info.png){width=300 fig-align=center fig-alt="The previous example in tidy data format"}
