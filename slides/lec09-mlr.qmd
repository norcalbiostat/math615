...
* $x_{4}=1$ when \R{AREA='Lancaster'}, and 0 otherwise
* $x_{5}=1$ when \R{AREA='Long Beach'}, and 0 otherwise
* $x_{6}=1$ when \R{AREA='Glendora'}, and 0 otherwise
...
* $b_{4}$ Controlling for age, and gender, a person who lives in Lancaster has .06 (-.25, .37) higher lung function than a person living in Burbank.
* $b_{5}$ Controlling for age, and gender, a person who lives in Long Beach has .21 (-.16, .60) higher lung function than a person who lives in Burbank.
* $b_{6}$ Controlling for age, and gender, a person who lives in Glendora has .15 (-.15, .45) higher lung function than a person who lives in Burbank.
:::

::::

None of these differences are significant, so we can conclude that after controlling for age, height, and gender, residential area does not have an effect on the persons lung function. This can also be noticed by the lack of increase in the $R^{2}$ value compared to the simpler model
