...
-   Click on three lines in the bottom right to see options for exporting a copy in other formats. 
...
-   I will also record each (most) class sessions. 
-   These will be posted in Canvas
