...
# Quantitative Outcome \~ Binary Covariate {background-image="plot2norm.png" background-opacity="0.3"}
...
# Quant ~ Cat {background-image="plot3norm.png" background-opacity="0.3"}

```{r, include=FALSE}
#| echo: false
plot_3norm(mean1 = 20, mean2 = 25, mean3=45, sd1 = 10, sd2 = 8, sd3=15, n = 100)
ggsave(filename="plot3norm.png")
```
