...
png(filename = here::here("slides/images/ansQtet.png"), 
    width=1000, height = 800)
par(mfrow=c(2,2), mai=c(0,0,0,0), omi = c(2.5,.5,2.5,.5))
plot(ans$x1, ans$y1, axes = F, xlab="", ylab="", pch=19); 
abline(lm(y1 ~ x1, data = ans), col = "blue");box()
plot(ans$x2, ans$y2, axes = F, xlab="", ylab="", pch=19); box()
abline(lm(y2 ~ x2, data = ans), col = "blue");box()
plot(ans$x3, ans$y3, axes = F, xlab="", ylab="", pch=19); box()
abline(lm(y3 ~ x3, data = ans), col = "blue");box()
plot(ans$x4, ans$y4, axes = F, xlab="", ylab="", pch=19); box()
abline(lm(y4 ~ x4, data = ans), col = "blue");box()
dev.off()

```


# Quantitative Outcome \~ Quantitative Covariate  {background-image="images/ansQtet.png" background-opacity="0.3"}
