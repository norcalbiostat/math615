...
-   [Teaching of Statistics in the Health Sciences Resources Portal](https://causeweb.org/tshs/category/dataset/)
...
Following the [Guide for Authors](https://math615.netlify.app/author_guide.html) you will submit a draft after Phase 3 that will be peer reviewed, and a final report at the end of the semester. 
...
-   `Not Assessable`: No content presented.
-   `SR`: Substantial revisions needed. This is C level work.
-   `MR`: Minor revisions needed. This is B level work.
-   `E` : Exceptional work. This is A level work.
