...
https://math615.netlify.app/project
...
* There are 20 or more variables 
    ...
    * At least 4 categorical variable 

:::

Download [this quarto template](https://math615.netlify.app/hw/_templates/project_stage1_template.qmd) and save it in your `projects` folder. 
Answer the following questions in the template, render to PDF and upload it, and a copy of the data to Canvas by the due date.  
