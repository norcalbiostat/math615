...
- Phase 1: Choose a data set and identify a few research topics
...
Your research team will produce two separate deliverable: a research poster and a report to be submitted to the [Journal of Math 615](journal.qmd).
...
You will also disseminate your findings by submitting a short journal article format called a research report to the internal **Journal of Math 615**. These reports will be compiled into an internal journal with selected images decorating the cover and published on the course website for future cohorts.

See the [Guide for Authors](https://math615.netlify.app/author_guide.html) for more details.

### 🚧 Peer Review

After Phase 3 and 5 you will submit PDF draft copies of your research report to the journal editor (your instructor) via Canvas for feedback, peer review and scoring. It is expected that you revise your work after each set of reviews.
