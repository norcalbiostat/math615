...
### Creating the poster in a reproducible format
* You will transfer all findings into a research poster, print the poster, and then present your research to your classmates. 
* You will create a new script file, named `userid_poster.qmd` that replicates all the findings, graphs and analysis done for your poster. 
    - You will also turn in your data management file (`userid_dm.qmd`) along with this script file. 
    - I should be able to reproduce every finding in your poster with the raw data, and these two script files. 
    - The more code I have to change to get your script to run, or if I can't reproduce a finding the lower your score
* Submit the poster file itself (as PDF) into the `Project-02 Poster Final` Google Drive folder, and the code in the `Poster code submision` subfolder. 

### Presentations & Evaluations
* We will split the class in half. When not presenting, you will be scoring the other half of the class's posters using [this scoring sheet](https://forms.gle/SWBM96MjcEmMDHGo9)
