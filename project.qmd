...
-   [Phase 1: Choose a data set and identify a few research topics](https://math615.netlify.app/project#stage-1-choose-a-data-set-and-identify-a-few-research-topics)
-   [Phase 2: Introduce your project and variables of interest](https://math615.netlify.app/project#stage-2-introduce-your-research-question-and-variables-of-interest)
-   [Phase 3: Explore your data and relationships](https://math615.netlify.app/project#stage-3-exploratory-data-analysis)
-   [Phase 4: Analyze bivariate relationships](https://math615.netlify.app/project#stage-4-bivariate-inference)
-   [Phase 5: Multivariable modeling & summarizing findings](https://math615.netlify.app/project#stage-5-multivariable-modeling-summarizing-findings)
-   [Phase 6: Dissemination (Poster Presentation and brief "publication")](https://math615.netlify.app/project#stage-6-dissemination)
...
After Phase 3 and 5 you will submit PDF draft copies of your research brief to the journal editor (your instructor) via Canvas for feedback, peer review and scoring. It is expected that you revise your work after each set of reviews.
...
### Phase 1: Propose a research topic and corresponding data set
...
3.  Fill out the required information on slides 1 -7. These slides for this phase are pale yellow in the template.
...
Fill out the required information on slides 9, 10, 11 and 13. These slides for this phase are pale blue in the template.
...
### 🚧 Phase 5: Multivariable modeling & summarizing findings
