...
subtitle: "Brainstorming research questions to investigate"
---

# Purpose

Learn more about your chosen research data and formulate a testable research hypothesis. This will guide your focus for the rest of the semester. In this assignment you will

1. Decide on a specific research topic
2. Choose variables that relate to your topic
3. Formulate a testable research hypothesis (or Research Question - RQ)
...
### Draft
* You will conduct the work directly in a Google document in the `02 Research Question and Codebook/draft` folder. 
* Name this file `rq_userid` 
* Use header formats to clearly denote the required sections (see below for examples).  


### Peer Review Instructions
* After the draft due date, check the Peer review assignment sheet for your assignments. 
* In Google Docs directly, use the commenting feature to provide feedback on this assignment. 
* Check the [[peer review section on the help page]](help.html#peer-review) page for additional instructions and guidance on how to provide a review. 
...
### Final
* Move your final version for scoring to the `02 Research Question and Codebook/final` folder. Make sure all revisions, track changes and comments are resolved.  
...
* Don't reinvent the wheel - take little screenshots with the snipping tool. 
        - In the pdf file, go to Edit, Take a Snap Shot, then click and drag over what you want. 
        - If you are on a MAC, press Shift+Command+Ctrl+4 to get the snip tool.
...
### Step 1: 
* Put the reference for the article in APA style. Here is a link to [Purdue Owl APA style](https://owl.purdue.edu/) references that will guide you.  
...
* Good/suggested bibliography managers
    - BibDesk (Mac) [http://bibdesk.sourceforge.net/](http://bibdesk.sourceforge.net/ )
    - Zotero (in browser) [https://www.zotero.org/](https://www.zotero.org/)
    - Mendeley (download) [https://www.mendeley.com/](https://www.mendeley.com/ ) 
* Using reference managers such as zotero and *.bib files with R Markdown
    - [Tyler Clavelle reference tips](https://www.tylerclavelle.com/code/2017/references/)
    - [Rmarkdown template http://svmiller.com/blog/2016/02/svm-r-markdown-manuscript/
    - [Rmarkdown cookbook](https://bookdown.org/yihui/rmarkdown-cookbook/bibliography.html)
