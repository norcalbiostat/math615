...
* Do the work for this assignment in whatever document system you prefer (e.g. word, google docs, etc. )
    - Using header formats to clearly denote the required sections (see below for examples).  
* Export to PDF and upload to Canvas by the due date.
