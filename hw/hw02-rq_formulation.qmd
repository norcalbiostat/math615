...
* Create a new Quarto document by clicking _File_ --> _New File_ --> _Quarto Document_ from the R menu. 
    - Save this file in your `project` folder
    - Name it something reasonable about project stage 2 or homework 2. 
    - Write your answers directly in this document, using header formats to clearly denote the required sections (see below for examples).  Render to PDF and upload to Canvas by the due date.
