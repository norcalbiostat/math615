...
3. **Bonita computed a z-score after receiving the results of her exam in order to compare her results with the rest of the class. Her z-score was 2.1. Interpret her Z score in a sentence.**
...
5. **Let $X$ be the head length of a brushtail possum, where $X \sim N(92.6, 3.6^{2})$ Use R to calculate the probability that a possum will have a head length lower than 85mm. That is, find $P(X < 85)$**.



6. **Would you consider it to be unusual if you found a possum with a head smaller than 85mm? Explain your answer.**



7. **A study found that the mean amount of time cars spent in drive-through of a certain fast-food restaurant was 154.6 seconds. Assume drive-through times are normally distributed with a standard deviation of 27 seconds**
