...
1.  Download [this template starter script](_templates/dm_dataset.qmd) and save it into your `math615/script` folder. Rename the `dataset` portion of the file name to your data name (e.g. `dm_addhealth`)
...
-   You will submit your code file to Canvas. This must run on my computer.
    ...
    -   You will upload your data set to a Box link contained in Canvas. 

If there are questions I may ask you to demonstrate your code to me in person.

:::{.callout-important}
#### Ensure Reproducibility

To ensure reproducibility between research partners, AND my self, you must do the following: 

* Be using an R Project for this class
* Your data must be in your `data` folder, and your scripts must be your `scripts` folder
* Use the `here::here()` method of accessing your data
...
Here is an example using Quarto. Everything you see below this line comes is written in the `.qmd` script itself. This is an example of literate programming where you write what you are going to do, do it in code, and then write what you have learned after each step.
:::
