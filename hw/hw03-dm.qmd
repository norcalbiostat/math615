...
1. Create a new script file named `dm_dataname_username.qmd` (e.g. `dm_addhealth_rdonatello.qmd`)
    - Make sure this is your **math615/script** folder, and your data is in your **math615/data** folder
2. After you load the data, restrict the variables to only the ones you are investigating using the `select` function from the `dplyr` package. 
...
Reference [lec03b-data_prep](../slides/lec03b-data_prep.html) and [ASCN Chapter 1](https://norcalbiostat.github.io/AppliedStatistics_notes/) on how you can explore your data and start to make data edits using R. 
