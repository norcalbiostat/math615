---
title: "HW 05: Bivariate Graphing"
...
* Use the template provided: [[RMD]](_templates/05_biv_graphing_template.Rmd) for R users, and [[Word]](_templates/05_biv_graphing_template.docx) for SPSS users.
    - Rename this file to `biv_graphing_userid`
* Upload your draft PDF to `05 Bivariate Graphing/draft` folder in Google Drive.
...
* Upload your final PDF to `05 Bivariate Graphing/final` folder in Google Drive.
