...
* Use the template provided: [[RMD]](templates/04_univ_graphing_template.Rmd) for R users, and [[Word]](templates/04_univ_graphing_template.docx) for SPSS users.
    - Rename this file to `univ_graphing_userid`
...
* "Submit" a note to the assignment in BBL so I can use the rubric for scoring. 
