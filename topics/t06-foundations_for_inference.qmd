...
We will be using the [Jigsaw](https://en.wikipedia.org/wiki/Jigsaw_(teaching_technique)) technique, which is a method of [learning by teaching](https://en.wikipedia.org/wiki/Learning_by_teaching). You have been assigned to read and summarize one section in the textbook. 
